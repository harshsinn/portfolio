...
$(document).ready(function() {
    $(window).scroll(function() {
      if ($(this).scrollTop() > 100) { /* Adjust the scroll distance for the button to appear */
    ...
    $('.scroll-up-btn').click(function() {
      $('html, body').animate({scrollTop : 0}, 800); /* Adjust the scroll animation speed if needed */
      return false;
    });
  });
